...
```{r linewidth=80}
readLines("https://raw.githubusercontent.com/Dhruv-Nambiar/36-350/main/README.md")
```
...
source_url("https://raw.githubusercontent.com/Dhruv-Nambiar/36-350/main/dark_and_stormy.R")
```
